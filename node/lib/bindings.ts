export interface WasmExports {
    ...
    tl_parse: (ptr: number, len: number, opts: number) => number;
    tl_dom_version: (ptr: number) => number;
    tl_dom_nodes_count: (ptr: number) => number;
    tl_dom_get_element_by_id: (ptr: number, len: number, id: number) => number;
    tl_dom_get_elements_by_class_name: (ptr: number, class_name: number, class_name_len: number) => number;
    tl_dom_query_selector_single: (ptr: number, selector: number, selector_len: number) => number;
    tl_dom_query_selector_all: (ptr: number, selector: number, selector_len: number) => number;
    ...
    drop_string_option: (ptr: number) => void;
